 ...
 *
 * Placeholder layout with a split hero and spacious card rail.
 *
...
<div
	...
	tabindex="0"
>
	<div class="ztp-fs__featured ztp-fs__featured--reverse">
		<div class="ztp-fs__featured-content ztp-fs__featured-content--soft">
		...
		<?php if ( ! empty( $show['image'] ) ) : ?>
			<div class="ztp-fs__featured-media ztp-fs__featured-media--wide">
	...
	<?php if ( ! empty( $show['cards'] ) && ! empty( $cards ) ) : ?>
		<div class="ztp-fs__cards ztp-fs__cards--soft" data-ztp-cards>
