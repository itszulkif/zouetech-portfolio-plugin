 ...
 *
 * Placeholder layout with a layered featured panel and editorial cards.
 *
...
<div
	...
	tabindex="0"
>
	<div class="ztp-fs__featured ztp-fs__featured--stacked">
		<?php if ( ! empty( $show['image'] ) ) : ?>
			<div class="ztp-fs__featured-media ztp-fs__featured-media--card">
				<img
		...
		<div class="ztp-fs__featured-content ztp-fs__featured-content--panel">
			<div class="ztp-fs__eyebrow"><?php esc_html_e( 'Featured Project', 'zouetech-portfolio' ); ?></div>
			...
			<?php if ( ! empty( $show['nav'] ) ) : ?>
				<div class="ztp-fs__nav ztp-fs__nav--inline">
	...
	<?php if ( ! empty( $show['cards'] ) && ! empty( $cards ) ) : ?>
		<div class="ztp-fs__cards ztp-fs__cards--editorial" data-ztp-cards>
