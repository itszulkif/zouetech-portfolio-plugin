<?php
/**
 * Featured Portfolio Showcase — Card Style 4.
 *
 * Placeholder layout with a centered hero and elevated cards.
 *
...
<div
	...
	tabindex="0"
>
	<div class="ztp-fs__featured ztp-fs__featured--centered">
		<?php if ( ! empty( $show['image'] ) ) : ?>
			<div class="ztp-fs__featured-media ztp-fs__featured-media--hero">
		...
		<div class="ztp-fs__featured-content ztp-fs__featured-content--centered">
			...
			<?php if ( ! empty( $show['nav'] ) ) : ?>
				<div class="ztp-fs__nav ztp-fs__nav--centered">
	...
	<?php if ( ! empty( $show['cards'] ) && ! empty( $cards ) ) : ?>
		<div class="ztp-fs__cards ztp-fs__cards--lifted" data-ztp-cards>
